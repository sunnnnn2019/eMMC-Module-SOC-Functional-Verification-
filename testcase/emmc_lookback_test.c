...
//NORMAL_INT_STAT_EN_R
  ...
  //PRBS_CNFG
  emmc_wio_16(0x318,0x1234);
  //PHYLPBK_CNFG
  emmc_wio_16(0x31a,0x1);
  //CMDPAD_CNFG
  emmc_rio_16(0x304,&rdata_16);
  emmc_wio_16(0x304,rdata_16|0x7);
  //DATPAD_CNFG
  emmc_rio_16(0x306,&rdata_16);
  emmc_wio_16(0x306,rdata_16|0x7);
  ////SDCLKDL_CNFG
  //emmc_wio_8(0x31d,0x10);
  ////SMPLDL_CNFG
  //emmc_wio_8(0x320,0x11);

  for(i=0;i<80;i=i+1){
      a_printf("wait %d of 80...\n",i);
  }

  emmc_wio_16(0x4,0x200);//BLOCKSIZE_R
  emmc_wio_32(0x0,0x1);//Block Count
  emmc_wio_16(0xc,0x32);//XFER_MODE_R
  emmc_wio_32(0x8,0x0);//ARGUEMENT_R
  emmc_wio_16(0xe,0x123a);//CMD_R

  for(i=0;i<80;i=i+1){
      a_printf("wait %d of 80...\n",i);
  }

  emmc_rio_16_expect(0x30,0x20,0x20,50);    //NORMAL_INT_STAT_R
  emmc_rio_16(0x32,&rdata_16);    //ERROR_INT_STAT_R
  rdata_16 = rdata_16 & 0x7f;
  if(rdata_16 != 0){
    a_printf("Loopback test error, error code is 0x%x\n",rdata_16);
  }
